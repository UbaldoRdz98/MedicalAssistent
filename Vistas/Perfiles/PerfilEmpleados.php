...
<head>
    ...
    <title>Medical Assistent - Perfil del Empleado</title>
...
<body>
    <?php
        ...
        if(isset($_SESSION["Usuario"]))
        {
            ...
            {
                if(($_SESSION["TipoUsuario"] == 'Doctor') || ($_SESSION["TipoUsuario"] == 'Analista'))
                {
        ...
        <div class='container'>
            ...
            <form method='POST'>
                <div class='mb-3 w-100'>
                    <label class='class-label'>Id_Empleado:</label>
                    <?php
                        include '../../Database/Database.php';
                        $db=new Database();
                        $db->ConectarDB();
            
                        $Query="CALL BuscaEmpleado2 (".$_SESSION["Id_Usuario"].")";
                        $reg = $db->Selects($Query);
                        foreach($reg as $valor)
                        {
                echo "
                    <input type='text' name='Id_Empleado' class='form-control text-uppercase' value='".$valor->Id_Empleado."' disabled>
                </div>
                <div class='mb-3 w-100'>
                    <label class='class-label'>Departamento:</label>
                    <input type='text' name='Departamento' class='form-control' value='".$valor->Departamento."' disabled>
                </div>
                <div class='mb-3 w-100'>
                    <label class='class-label'>Departamento:</label>
                    <input type='text' name='Departamento' class='form-control' value='".$valor->Puesto."' disabled>
                </div>
                <div class='mb-3 w-100'>
        ...
        echo "  </select>
            ...
            <input type='text' name='idemp' class='form-control' value='$valor->Id_Empleado' hidden>";
            }
            echo"<button type='submit' class='btn btn-outline-success' href='PerfilEmpleados.php'>Guardar Cambios</button>
